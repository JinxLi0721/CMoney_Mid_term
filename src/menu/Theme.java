...
public class Theme {
    ...
    public static final Theme DEFAULT_THEME = new Theme(
            new Style.StyleRect(150, 70, true, new BackgroundColor(new Color(112, 128, 105)))
                    .setText("GOOD")
            ...
            new Style.StyleRect(150, 70, true, new BackgroundColor(new Color(169, 169, 169)))
                    .setHaveBorder(true)
                    ...
                    .setTextColor(Color.WHITE)
                    .setTextFont(new Font("TimesRoman", Font.BOLD, 30)),
            new Style.StyleRect(150, 70, true, new BackgroundColor(new Color(178, 34, 34)))
                    .setText("FOCUS")
