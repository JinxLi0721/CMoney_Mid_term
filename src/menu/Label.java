...
public class Label implements GameKernel.GameInterface {
    ...
    public void clickedToEndPerformed() {
        ClickedToEnd.clickedActionPerformed();
    }
