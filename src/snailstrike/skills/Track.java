...
public class Track extends Skill{
    
    public Track(int snailEmissionNum, String kindOfSkill, Snail snailReference, int x, int y, int r, int skillPower, Vector vector) {
        super(snailEmissionNum, kindOfSkill, x, y, r, vector);
        this.animator = new SkillAnimator(SceneController.instance().irc().tryGetImage(new Path().img().skills().track()),
