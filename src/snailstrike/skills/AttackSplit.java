...
public class AttackSplit extends Skill {

    public AttackSplit(int snailEmissionNum, String kindOfSkill, int x, int y, int r, int skillPower, Vector vector) {
        super(snailEmissionNum, kindOfSkill, x, y, r, vector);
        this.animator = new SkillAnimator(SceneController.instance().irc().tryGetImage(new Path().img().skills().smog()),
